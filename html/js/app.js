...
function handleDragDrop() {
    $(".item-drag").draggable({
        ...
        start: function(event, ui) {
            ...
            if (!itemData.useable) {
                // $("#item-use").css("background", "rgba(35,35,35, 0.6");
            }
            ...
            if (fromData.amount == $toAmount) {
                ...
                if ($toSlot < 6 && $toInv.attr("data-inventory") == "player") {
                    ...
                    $toInv
                        .find("[data-slot=" + $toSlot + "]")
                        .html(
                            '<div class="item-slot-key"><p>6 </p></div><div class="item-slot-img"><img src="images/' +
                            newData.image +
                            '" alt="' +
                            newData.name +
                            '" /></div><div class="item-slot-amount"><p>' +
                ...
                if ($toSlot < 6 && $toInv.attr("data-inventory") == "player") {
                    ...
                    $toInv
                        .find("[data-slot=" + $toSlot + "]")
                        .html(
                            '<div class="item-slot-key"><p>6</i></p></div><div class="item-slot-img"><img src="images/' +
                            newData.image +
                            '" alt="' +
                            newData.name +
                            '" /></div><div class="item-slot-amount"><p>' +
                ...
                if (toData != undefined) {
                    ...
                    if ($fromSlot < 6 && $fromInv.attr("data-inventory") == "player") {
                        ...
                        $fromInv
                            .find("[data-slot=" + $fromSlot + "]")
                            .html(
                                '<div class="item-slot-key"><p>6</p></div><div class="item-slot-img"></div><div class="item-slot-label"><p>&nbsp;</p></div>'
                            );
                    } else {
                        $fromInv
                            .find("[data-slot=" + $fromSlot + "]")
...
function InventoryError($elinv, $elslot) {
    $elinv
        ...
        .css("background", "rgba(156, 20, 20, 0.6)")
...
(() => {
        ...
        for (i = 6; i < data.slots + 1; i++) {
            if (i == 41) {
                $(".player-inventory").append(
                    '<div class="item-slot" data-slot="' +
                    i +
                    '"><div class="item-slot-key"><p>6</p></div><div class="item-slot-img"></div><div class="item-slot-label"><p>&nbsp;</p></div></div>'
                );
            } else {
                $(".player-inventory").append(
                    '<div class="item-slot" data-slot="' +
    ...
    Inventory.ToggleHotbar = function(data) {
        if (data.open) {
            ...
            // var elem =
            //     '<div class="z-hotbar-item-slot" data-zhotbarslot="41"> <div class="z-hotbar-item-slot-key"><p>6 <i style="top: -62px; left: 58px;></i></p></div><div class="z-hotbar-item-slot-img"></div><div class="z-hotbar-item-slot-label"><p>&nbsp;</p></div></div>';
            // $(".z-hotbar-inventory").append(elem);
                ...
                if (item != null) {
                    ...
                    if (item.slot == 41) {
                        $(".z-hotbar-inventory")
                            .find("[data-zhotbarslot=" + item.slot + "]")
                            .html(
                                '<div class="z-hotbar-item-slot-key"><p>6 <i style="top: -62px; left: 58px;"></i></p></div><div class="z-hotbar-item-slot-img"><img src="images/' +
                                item.image +
                                '" alt="' +
                                item.name +
